...
export const registerSchema = z
	.object({
		username: z
			...
			.trim()
			.regex(/^[A-Za-z0-9-_]+$/,
				'Username can contain only A-Z, a-z, - or _')
		...
		terms: z.boolean().refine(value => value, {message: 'Please, review and agree to the Terms of Service and Privacy Policy to proceed'}),
		password: z
			.string()
			.trim()
